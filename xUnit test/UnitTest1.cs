    ...
    public class PaperStoreRepositoryTests
    {
        private async Task<MyDbContext> GetInMemoryDbContextAsync()
        {
            var options = new DbContextOptionsBuilder<MyDbContext>()
                .UseInMemoryDatabase(databaseName: "PaperStoreTestDb")
                .Options;
        ...
        private async Task SeedDataAsync(MyDbContext context)
        {
            ...
            {
                new Property { Id = 1, PropertyName = "Color", PropertyValue = "White" },
                new Property { Id = 2, PropertyName = "Texture", PropertyValue = "Smooth" }
            };

            var papers = new List<Paper>
            {
                new Paper { Id = 1, Name = "Paper A", Stock = 10, Discontinued = false, Properties = new List<Property> { properties[0] } },
                new Paper { Id = 2, Name = "Paper B", Stock = 0, Discontinued = true }
            };
